...
def set_seed(seed):
    random.seed(seed) # random module's seed
    np.random.seed(seed) # numpy module's seed
    torch.manual_seed(seed) # torch module's seed
    torch.cuda.manual_seed_all(seed) # torch.cuda module's seed
